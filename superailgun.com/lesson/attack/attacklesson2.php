        ...
        <nav class="sidenav shadow-right sidenav-light">
            <div class="sidenav-menu">
                <div class="nav accordion" id="accordionSidenav">
                    ...
                    <a class="nav-link disabled" href="attacklesson2.php" style="color:#0061f2;">
                        <div class="nav-link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="page-header-content">
                        <h1 class="page-header-title">
                            ...
                            <span> &nbsp; Attack Lesson 2</span>
                        </h1>
                        <div class="page-header-subtitle">In this lesson, we will teach you how to get the location of the Database files</div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="sbp-preview">
                                        <div class="sbp-preview-content bg-light">
                                            <div class="sbp-preview-text">
                                                <h2>Get the location of the database files</h2><br><br>
                                                This is one of the most sample SQL injection in the world. Knowing the location of the database files is important for some attackers. The location of the database files is a common target for attackers.
                                                If the attacker knows the location, he/she will not need to guess where the database is. So, they can focus in find some hostname or version information.<br><br>

                                                The SQL syntax executed by PHP is as follows. The main function is to retrieve the location of the database in any table.<br><br>
...
<span class="sqlkeywordcolor">SELECT</span> @@datadir;
                                                                </code></pre>
                                                </div><br><br>

                                                In this case, users can get the location of the database.<br><br>
                                                ...
                                                <div class="tab-pane active">
                                                            <pre class="  language-markup">
                                                                <code class="  language-markup">
1;<span class="sqlkeywordcolor">SELECT</span> @@datadir;
                                                                </code></pre>
                                                </div><br><br>



                                                In this case, the attacker can get the location of the database by query.
                                    ...
                                    <div class="sbp-preview">
                                        <div class="sbp-preview-content bg-light">
                                            <div class="sbp-preview-text">
                                                ...
                                                When the attacker obtains the location of the database, weak points gets spotted much easier. Attackers may use some other attack method, like path traversal, to access any files and directories stored on the file system, including application source code or configuration and critical system files. If this happens, the company will be entirely exposed to attackers
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-green" role="alert" id="tips3">
                                        Tips 3 : Input <code>1;SELECT @@datadir;</code>
                                    </div>
                                        ...
                                        <div class="bookbox" id="bookbox">
                                            ...
                                            <div   id="correctinput">
                                                ...
                                                <div class="alert alert-green" role="alert" >
                                                    ...
                                                    Well done! you now learned how to get the location of the database files. <br>
                                                    You get <span id="marks">0</span> / 3 marks in lesson 2.<br><br>
                                                    ...
                                                    <a href="attacklesson3.php" type="button" class="btn btn-blue m-3" >Lesson 3</a>
        ...
        $("#logon").click(function(){
            ...
            $.post("sql/lesson2_sql.php", {  pwd: pwd },
                ...
                if (obj.testresult==0){
                    ...
                    $.post("/updatetable.php", { table: "attack" , lesson: "Lesson2", mark:marks });
