        ...
        <nav class="sidenav shadow-right sidenav-light">
            <div class="sidenav-menu">
                <div class="nav accordion" id="accordionSidenav">
                    ...
                    <a class="nav-link disabled" href="attacklesson9.php" style="color:#0061f2;">
                        <div class="nav-link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="page-header-content">
                        <h1 class="page-header-title">
                            ...
                            <span> &nbsp; Attack Lesson 9</span>
                        </h1>
                        <div class="page-header-subtitle">In this lesson, we will teach you how to drop the table through sql injection</div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="sbp-preview">
                                        <div class="sbp-preview-content bg-light">
                                            <div class="sbp-preview-text">
                                                <h2>Introduction of drop table</h2><br><br>
                                                All data are record in different table. If tables are dropped by someone, the consequence is formidable. It will make the company lost all records and even collapse.<br><br>


                                                The SQL syntax executed by PHP is as follows. The main function is dropping the table called record.<br><br>
...
<span class="sqlkeywordcolor">DROP TABLE </span> test;
                                                                </code></pre>
                                                </div><br><br>

                                                If the PHP file is allowed to execute two SQL commands at the same time. <br>
                                                In that time, the SQL command will be:<br><br>

                                                <div class="tab-pane active">
                                                            <pre class="  language-markup">
                                                                <code class="  language-markup">
<span class="sqlkeywordcolor">SELECT</span> * <span class="sqlkeywordcolor">FROM</span> t_user <span class="sqlkeywordcolor">WHERE</span> id =1; <span class="sqlkeywordcolor">DROP TABLE </span> test;
                                                                </code></pre>
                                                </div><br><br>

                                                In this case, the attacker can drop the table called record by query.
                                    ...
                                    <div class="sbp-preview">
                                        <div class="sbp-preview-content bg-light">
                                            <div class="sbp-preview-text">
                                                ...
                                                When <code>DROP</code> function is executed, not only are the columns deleted, but also its related indexes, keys, definitions. Thereby, even 'untouched' tables will be affected as well. <br><br>
                                                Deleting data can cause considerable damage to a financial company. User personal information, their trade history, their savings can all be deleted very quickly. And without recovery tools and backups, a company will lose its customers, reputation and source of income.<br><br>
                                                It is probably the most devastating attack.
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-green" role="alert" id="tips3">
                                        Tips 3 : Input <code>1; DROP TABLE test</code>
                                    </div>
                                        ...
                                        <div class="bookbox" id="bookbox">
                                            ...
                                            <div   id="correctinput">
                                                ...
                                                <div class="alert alert-green" role="alert" >
                                                    ...
                                                    You get <span id="marks">0</span> / 3 marks in lesson 9.<br><br>
                                                    ...
                                                    <a href="attacklesson10.php" type="button" class="btn btn-blue m-3" >Lesson 10</a>
...
<script>
    $(document).ready(function(){
        $("#logon").click(function(){
            ...
            pwd=$("#pw").val();
            $.post("sql/lesson9_sql.php", {  pwd: pwd },
                function(data){
                ...
                if (obj.testresult==0){
                    ...
                    $.post("/updatetable.php", { table: "attack" , lesson: "Lesson9", mark:marks });
