        ...
        <nav class="sidenav shadow-right sidenav-light">
            <div class="sidenav-menu">
                <div class="nav accordion" id="accordionSidenav">
                    ...
                    <a class="nav-link disabled" href="attacklesson5.php" style="color:#0061f2;">
                        <div class="nav-link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="page-header-content">
                        <h1 class="page-header-title">
                            ...
                            <span> &nbsp; Attack Lesson 5</span>
                        </h1>
                        <div class="page-header-subtitle">In this lesson, we will teach you how to get some table schemas of the database</div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="sbp-preview">
                                        <div class="sbp-preview-content bg-light">
                                            <div class="sbp-preview-text">
                                                <h2>Get table schemas of the database</h2><br><br>
                                                ...
                                                Unlike databases, schemas are not rigidly separated: a user can access objects in any of the schemas in the database they are connected to, if they have privileges to do so. <br><br>

                                                The SQL syntax executed by PHP is as follows. The main function is to retrieve all table schemas of the database in any table.<br><br>


                                                <div class="tab-pane active">
                                                            <pre class="  language-markup">
                                                                <code class="  language-markup">
<span class="sqlkeywordcolor">SELECT</span> table_schema <span class="sqlkeywordcolor">FROM</span> information_schema.tables ;
                                                                </code></pre>
                                                </div><br><br>

                                                In this case, users can get all table schemas of the database.<br><br>
                                                ...
                                                <div class="tab-pane active">
                                                            <pre class="  language-markup">
                                                                <code class="  language-markup">
<span class="sqlkeywordcolor">SELECT</span> * <span class="sqlkeywordcolor">FROM</span> t_user <span class="sqlkeywordcolor">WHERE</span> id = 1; <span class="sqlkeywordcolor">SELECT</span> table_schema <span class="sqlkeywordcolor">FROM</span> information_schema.tables ;
                                                                </code></pre>
                                                </div><br><br>



                                                In this case, the attacker can get all table schemas of the database by query.
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-green" role="alert" id="tips3">
                                        Tips 3 : Input <code>1;SELECT table_schema FROM information_schema.tables group by table_schema</code>
                                    </div>
                                        ...
                                        <div class="bookbox" id="bookbox">
                                            ...
                                            <div   id="correctinput">
                                                ...
                                                <div class="alert alert-green" role="alert" >
                                                    ...
                                                    Well done! you now learned how to get table schemas of the database. <br>
                                                    You get <span id="marks">0</span> / 3 marks in lesson 5.<br><br>
                                                    ...
                                                    <a href="attacklesson6.php" type="button" class="btn btn-blue m-3" >Lesson 6</a>
...
<script>
    $(document).ready(function(){
        $("#logon").click(function(){
            ...
            pwd=$("#pw").val();
            $.post("sql/lesson5_sql.php", {  pwd: pwd },
                function(data){
                ...
                if (obj.testresult==0){
                    ...
                    $.post("/updatetable.php", { table: "attack" , lesson: "Lesson5", mark:marks });
