        ...
        <nav class="sidenav shadow-right sidenav-light">
            <div class="sidenav-menu">
                <div class="nav accordion" id="accordionSidenav">
                    ...
                    <a class="nav-link disabled" href="attacklesson10.php" style="color:#0061f2;">
                        <div class="nav-link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="page-header-content">
                        <h1 class="page-header-title">
                            ...
                            <span> &nbsp; Attack Lesson 10</span>
                        </h1>
                        <div class="page-header-subtitle">In this lesson, we will teach you how to build an admin</div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="sbp-preview">
                                        <div class="sbp-preview-content bg-light">
                                            <div class="sbp-preview-text">
                                                <h2>Introduction of create an admin account</h2><br><br>
                                                An admin account can control all data in the database. It grants the right to insert, delete, update any data if you want. Creating an admin account means you can go directly to the database login interface and enter the account and password you designed to enter the database. No additional attack is required.<br><br>


                                                It will make the database uncontrolled, this is the most serious vulnerability.<br><br>

                                                The SQL syntax executed by PHP is as follows. If the website allows user input some special characters, such as <code>@</code>. The main function is create an admin account in any table.<br><br>


                                                <div class="tab-pane active">
                                                            <pre class="  language-markup">
                                                                <code class="  language-markup">
<span class="sqlkeywordcolor">GRANT ALL PRIVILEGES ON </span>  *.* <span class="sqlkeywordcolor">TO</span> 'Hacker'@'%';
                                                                </code></pre>
                                                </div><br><br>

                                                In this case, users can create an admin account called Hacker, and the password is null.<br>
                                                If the PHP file is allowed to execute two SQL commands at the same time. It will be:<br><br>


                                                <div class="tab-pane active">
                                                            <pre class="  language-markup">
                                                                <code class="  language-markup">
<span class="sqlkeywordcolor">SELECT</span> * <span class="sqlkeywordcolor">FROM</span> t_user <span class="sqlkeywordcolor">WHERE</span> id =1; <span class="sqlkeywordcolor">GRANT ALL PRIVILEGES ON </span>  *.* <span class="sqlkeywordcolor">TO</span> 'Hacker'@'%';
                                                                </code></pre>
                                                </div><br><br>

                                                In this case, the attacker can create an admin account called Hacker by query.
                                    ...
                                    <div class="sbp-preview">
                                        <div class="sbp-preview-content bg-light">
                                            <div class="sbp-preview-text">
                                                ...
                                                An attacker who has granted himself administrator rights can run many powerful statements, including alter, create and delete data. They can also manage other user's rights, opening door to other attackers and taking away other user's privileges. <br><br>
                                                This give attackers control over the database and will be difficult to recover from.
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-yellow" role="alert" id="tips1">
                                        Tips 1 : Input two commands
                                    </div>

                                    <div class="alert alert-blue" role="alert" id="tips2">
                                        Tips 2 : <code>GRANT ALL PRIVILEGES ON</code> , this command can set database permissions
                                    </div>

                                    <div class="alert alert-green" role="alert" id="tips3">
                                        Tips 3 : Input <code>1;GRANT ALL PRIVILEGES ON *.* TO 'Hacker'@'%';</code>
                                    </div>
                                    ...
                                    <div id="desktop">
                                        ...
                                        <div class="secbar">
                                            <div class="secbox">
                                                <a href=""><img src="/img/router.svg" alt=""></a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bookbox" id="bookbox">
                                            ...
                                            <br><br>
                                                ...
                                                <div class="bookbox" id="inputbox">
                                                    ...
                                                    <button class="button" id="logon" style="background-color: #fb8033;" >  QUOTE  </button><br><br>
                                            ...
                                            <div   id="correctinput">
                                                ...
                                                <div class="alert alert-green" role="alert" >
                                                    ...
                                                    Well done! you now learned how to get users password. <br>
                                                    You get <span id="marks">0</span> / 3 marks in lesson 10.<br><br>
                                                    ...
                                                    <a href="../defense/defenselesson1.php" type="button" class="btn btn-blue m-3" >Defense Lesson</a>
                                        ...
                                        <div class="bottombar">
                                            <div class="bottombox">
                                                ...
                                                <div class="copyright">All quotes delayed a minimum of 15 minutes. &nbsp;&nbsp;&nbsp;&nbsp;
                                                    ...
                                                    © 2020 Routers. All Rights Reserved.</div>
...
<script>
    $(document).ready(function(){
        $("#logon").click(function(){
            ...
            pwd=$("#pw").val();
            $.post("sql/lesson10_sql.php", {  pwd: pwd },
                function(data){
                ...
                if (obj.testresult==0){
                    ...
                    $.post("/updatetable.php", { table: "attack" , lesson: "Lesson10", mark:marks });
