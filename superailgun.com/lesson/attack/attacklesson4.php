        ...
        <nav class="sidenav shadow-right sidenav-light">
            <div class="sidenav-menu">
                <div class="nav accordion" id="accordionSidenav">
                    ...
                    <a class="nav-link disabled" href="attacklesson4.php" style="color:#0061f2;">
                        <div class="nav-link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="page-header-content">
                        <h1 class="page-header-title">
                            ...
                            <span> &nbsp; Attack Lesson 4</span>
                        </h1>
                        <div class="page-header-subtitle">In this lesson, we will teach you how to get the hostname</div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="sbp-preview">
                                        <div class="sbp-preview-content bg-light">
                                            <div class="sbp-preview-text">
                                                <h2>Get the hostname of the database</h2><br><br>
                                                The MySQL hostname will always be in your configuration files. If you need to connect to your database from your desktop, use your primary domain name or the server name that can be found in your account signup email.<br><br>

                                                The SQL syntax executed by PHP is as follows. The main function is to retrieve the hostname of the database in any table.<br><br>
...
<span class="sqlkeywordcolor">SELECT</span> @@hostname;
                                                                </code></pre>
                                                </div><br><br>

                                                In this case, users can retrieve the hostname of the database.<br><br>
                                                ...
                                                <div class="tab-pane active">
                                                            <pre class="  language-markup">
                                                                <code class="  language-markup">
<span class="sqlkeywordcolor">SELECT</span> * <span class="sqlkeywordcolor">FROM</span> t_user <span class="sqlkeywordcolor">WHERE</span> id = 1;<span class="sqlkeywordcolor">SELECT</span> @@hostname;
                                                                </code></pre>
                                                </div><br><br>



                                                In this case, the attacker can get the hostname of the database by query.
                                    ...
                                    <div class="sbp-preview">
                                        <div class="sbp-preview-content bg-light">
                                            <div class="sbp-preview-text">
                                                ...
                                                Starting off, the attacker will get the hostname of the database.
                                                This opens the door to more hints to attack your database.
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-blue" role="alert" id="tips2">
                                        Tips 2 : <code>;</code> can separate two commands
                                    </div>

                                    <div class="alert alert-green" role="alert" id="tips3">
                                        Tips 3 : Input <code>USD';SELECT @@hostname;</code>
                                    </div>
                                    ...
                                    <div id="desktop">
                                        ...
                                        <div class="mainbar">
                                            <div id="maintext">
                                                ...
                                                <div class="maintitle">Currency Converter</div>
                                        ...
                                        <div class="bookbox" id="bookbox">
                                            ...
                                            <br><br>
                                                ...
                                                <div class="bookbox" id="inputbox">
                                                    ...
                                                    <span class="inputword">Please enter currency  </span><br>
                                                    <input id="pw" name="pw" required="" min="1">


                                                    <button class="button" id="logon" style="background-color: #fb8033;">  CHECK  </button><br><br>
                                            ...
                                            <div   id="wronginput">
                                                ...
                                                <div class="alert alert-red" role="alert" >
                                                    ...
                                                    The SQL query that you input : <code>SELECT value FROM exchange WHERE Name = '<span id="query_pw">0</span>'</code><br><br>
                                            ...
                                            <div   id="correctinput">
                                                ...
                                                <div class="alert alert-green" role="alert" >
                                                    ...
                                                    Well done! you now learned how to get the hostname. <br>
                                                    You get <span id="marks">0</span> / 3 marks in lesson 4.<br><br>

                                                    The SQL query that you input : <code>SELECT value FROM exchange WHERE Name = '<span id="query_pw_1">0</span>'</code><br><br>
                                                    ...
                                                    <a href="attacklesson5.php" type="button" class="btn btn-blue m-3" >Lesson 5</a>
        ...
        $("#logon").click(function(){
            ...
            $.post("sql/lesson4_sql.php", {  pwd: pwd },
                ...
                if (obj.testresult==0){
                    ...
                    $.post("/updatetable.php", { table: "attack" , lesson: "Lesson4", mark:marks });
                    document.getElementById("marks").innerHTML = marks;
                    document.getElementById("query_pw_1").innerHTML = pwd;

                    obj2.forEach(function(obj) { document.getElementById("stockprice").innerHTML = document.getElementById("stockprice").innerHTML+"1 USD = "+obj+" HKD<br><br>"; });
