        ...
        <nav class="sidenav shadow-right sidenav-light">
            <div class="sidenav-menu">
                <div class="nav accordion" id="accordionSidenav">
                    ...
                    <a class="nav-link disabled" href="attacklesson8.php" style="color:#0061f2;">
                        <div class="nav-link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="page-header-content">
                        <h1 class="page-header-title">
                            ...
                            <span> &nbsp; Attack Lesson 8</span>
                        </h1>
                        <div class="page-header-subtitle">In this lesson, we will teach you how to get some user passwords through union function</div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="sbp-preview">
                                        <div class="sbp-preview-content bg-light">
                                            <div class="sbp-preview-text">
                                                <h2>Introduction of get users password</h2><br><br>
                                                Password is the most important data in database. If one gets hold of another’s password, he has complete access to that person’s account. This is a terrible thing.<br><br>
                                                ...
                                                The Union operator can only be used if the original/new queries have the same structure (number and data type of columns).<br><br>

                                                The SQL syntax executed by PHP is as follows. The main function is through union to get other users password.<br><br>
...
<span class="sqlkeywordcolor">SELECT</span> * <span class="sqlkeywordcolor">FROM</span> service <span class="sqlkeywordcolor">WHERE</span> id = 1 <span class="sqlkeywordcolor">UNION SELECT</span> password <span class="sqlkeywordcolor">FROM</span> record
                                                                </code></pre>
                                                </div><br><br>

                                                In this case, the attacker can find out the service which id called 1 from service table and find out all users password from the record table.
                                    ...
                                    <div class="sbp-preview">
                                        <div class="sbp-preview-content bg-light">
                                            <div class="sbp-preview-text">
                                                ...
                                                When a user's password (and probably username as well) is obtained, there are a few things an attacker could do.<br><br>
                                                They can download sensitive content, such as credit card number and banking information. They can sell user's credentials on the dark web. They can make fraudulent, maybe illegal, purchases. They can even use softwares to test out stolen account name and passwords on other websites, furthering the exploitation.
                        ...
                        <div id="test">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    &nbsp; &nbsp; Example table that include password : record <br><br>
                                    ...
                                    <div class="alert alert-yellow" role="alert" id="tips1">
                                        Tips 1 : Try to combine two sql commands
                                    </div>

                                    <div class="alert alert-blue" role="alert" id="tips2">
                                        Tips 2 : Use <code>union</code> can combine the result of two sql commands
                                    </div>

                                    <div class="alert alert-green" role="alert" id="tips3">
                                        Tips 3 : Input <code>1 UNION SELECT password FROM record</code>
                                    </div>
                                        ...
                                        <div class="bookbox" id="bookbox">
                                            ...
                                            <div   id="correctinput">
                                                ...
                                                <div class="alert alert-green" role="alert" >
                                                    ...
                                                    You get <span id="marks">0</span> / 3 marks in lesson 8.<br><br>
                                                    ...
                                                    <a href="attacklesson9.php" type="button" class="btn btn-blue m-3" >Lesson 9</a>
...
<script>
    $(document).ready(function(){
        $("#logon").click(function(){
            ...
            pwd=$("#pw").val();
            $.post("sql/lesson8_sql.php", {  pwd: pwd },
                function(data){
                ...
                if (obj.testresult==0){
                    ...
                    $.post("/updatetable.php", { table: "attack" , lesson: "Lesson8", mark:marks });
